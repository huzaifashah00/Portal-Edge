...
//        ]);
        ...
        SystemSetting::upsert([
            ...
            ["name" => "system_version", "data" => "1.3.3", "type" => "string"],
            ...
            ["name" => "system_name", "data" => "Portal Edge - Institutions Management System", "type" => "string"],
            ...
            ["name" => "short_description", "data" => "Portal Edge - Manage Your Institute", "type" => "text"],
        ...
        $systemSettings = [
            [
                'name' => 'hero_title_1',
                'data' => 'Opt for Portal Edge 14+ robust features for an enhanced educational experience.',
                'type' => 'text'
            ],
            [
                'name' => 'hero_title_2',
            ...
            [
                'name' => 'tag_line',
                'data' => 'Transform School Management With Portal Edge',
                'type' => 'text'
            ],
            [
                'name' => 'mobile',
            ...
            [
                ...
                'data' => 'Experience the future of education with our Portal Edge platform. Streamline attendance, assignments, exams, and more. Elevate your school\'s efficiency and engagement.',
                'type' => 'text'
            ],
            [
