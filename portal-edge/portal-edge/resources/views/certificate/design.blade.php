                                ...
                                <div class="d-flex">
                                    <div class="form-check w-fit-content ml-3">
                                        <label class="form-check-label ml-4">
                                            <input type="checkbox" class="form-check-input" {{ in_array('school_name', $certificateTemplate->fields) ? 'checked' : '' }} name="school_data[]" value="school_name">{{ __('Institute Name') }}
                                        </label>
                                    </div>

                                    <div class="form-check w-fit-content ml-3">
                                        <label class="form-check-label ml-4">
                                            <input type="checkbox" class="form-check-input" {{ in_array('school_logo', $certificateTemplate->fields) ? 'checked' : '' }} name="school_data[]" value="school_logo">{{ __('Institute Logo') }}
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check w-fit-content ml-3">
                                        <label class="form-check-label ml-4">
                                            <input type="checkbox" class="form-check-input" {{ in_array('school_address', $certificateTemplate->fields) ? 'checked' : '' }} name="school_data[]" value="school_address">{{ __('Institute Address') }}
                                        </label>
                                    </div>
                                    <div class="form-check w-fit-content ml-3">
                                        <label class="form-check-label ml-4">
                                            <input type="checkbox" class="form-check-input" {{ in_array('school_mobile', $certificateTemplate->fields) ? 'checked' : '' }} name="school_data[]" value="school_mobile">{{ __('Institute Mobile') }}
                                        </label>
                                    </div>
                                    <div class="form-check w-fit-content ml-3">
                                        <label class="form-check-label ml-4">
                                            <input type="checkbox" class="form-check-input" {{ in_array('school_email', $certificateTemplate->fields) ? 'checked' : '' }} name="school_data[]" value="school_email">{{ __('Institute Email') }}
                                        </label>
                                    </div>
