                        ...
                        <form id="formdata" class="setting-form" action="{{ route('system-settings.update', 1) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-12">
                                    <a data-value="{school_admin_name}" class="btn btn-gradient-light btn_tag mt-2">{ {{ __('Institute Admin Name') }} }</a>
                                    ...
                                    <a data-value="{school_name}" class="btn btn-gradient-light btn_tag mt-2">{ {{ __('Institute Name') }} }</a>
                                </div>
