                        ...
                        <form class="create-form school-registration-validate" enctype="multipart/form-data" action="{{ route('schools.store') }}" method="POST" novalidate="novalidate">
                            ...
                            <div class="bg-light p-4 mt-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label for="school_support_email">{{ __('Institute').' '.__('email') }} <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label for="school_support_phone">{{ __('Institute').' '.__('phone') }} <span class="text-danger">*</span></label>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list'
                               ...
                               data-export-options='{ "fileName": "{{__('Institute') }}-<?= date(' d-m-y') ?>" ,"ignoreColumn":["operate"]}'
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="support_email">{{__('Institute').' '.__('email')}}</th>
                                <th scope="col" data-field="support_phone">{{__('Institute').' '.__('phone')}}</th>
                                ...
                                <th scope="col" data-field="user" data-formatter="schoolAdminFormatter">{{ __('Institute').' '.__('admin') }}</th>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{__('edit')}} {{__('Institute')}}</h5>
                ...
                <form id="edit-form" class="pt-3 edit-form" action="{{ url('schools') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group col-sm-12 col-md-3">
                            <label for="edit_school_support_email">{{ __('Institute').' '.__('email') }} <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group col-sm-12 col-md-3">
                            <label for="edit_school_support_phone">{{ __('Institute').' '.__('phone') }} <span class="text-danger">*</span></label>
